...
/**
 * @author :  Amayadream
 * @date :  2016.03.01 22:19
 */

public class MongoUtil {
    private volatile static MongoOperations mongoOperation;
    private static final String CONFIG_FILE_NAME = "mongodb";
    ...
    public static MongoOperations getMongoOperation() {
        if (mongoOperation == null) {
            ...
            String hostAddr = resourceBundle.getString(KEY_HOST) + ":" + resourceBundle.getString(KEY_PORT);
            UserCredentials userCredentials = new UserCredentials(resourceBundle.getString(KEY_USERNAME), resourceBundle.getString(KEY_PASSWORD));
            try {
